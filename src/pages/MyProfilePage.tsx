    ...
    return (
      <div className="bg-gray-50 min-h-screen py-12">
        <div className="max-w-3xl mx-auto px-6">
          ...
          {[0, 1, 2].map((k) => (
            <div key={k} className="bg-white border border-gray-200 rounded-xl p-6 mt-6 space-y-4">
              <div className="h-5 w-40 bg-gray-200 rounded animate-pulse" />
              <div className="h-11 bg-gray-100 rounded animate-pulse" />
              <div className="grid grid-cols-2 gap-3">
                <div className="h-11 bg-gray-100 rounded animate-pulse" />
                <div className="h-11 bg-gray-100 rounded animate-pulse" />
              </div>
              <div className="h-11 bg-gray-200 rounded animate-pulse w-1/3" />
            </div>
          ))}
        </div>
      </div>
