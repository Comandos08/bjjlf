...
INSERT INTO public.academy_permits (
  academy_name, responsible_name, email, phone,
  address, city, state, country, country_code, country_flag,
  status, amount_cents
) VALUES (
  'Lotus Club Brazilian Jiu-Jitsu Milano',
  'Ricardo Luís Carpentieri Mendes',
  'cuordileonebjj@gmail.com', '+39 3313188503',
...
INSERT INTO public.academy_permits (
  academy_name, responsible_name, email,
...
-- 4. GTK Academy of Martial Arts (EUA)
INSERT INTO public.academy_permits (
  academy_name, responsible_name, email, phone,
  address, city, state, country, country_code, country_flag,
  website, status, amount_cents
) VALUES (
  'GTK Academy of Martial Arts',
  'Godfrey Allen Knowles',
  'info@gtkmartialartsacademy.com', '(571) 322-1722',
